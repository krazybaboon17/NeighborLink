    ...
    switch (type) {
      ...
      case "moderate-task": {
        ...
        messages = [
          {
            role: "system",
            content: `You are a NARROW content moderator for Taskify, a community task marketplace. Your job is to ONLY block content that falls into these three categories:
