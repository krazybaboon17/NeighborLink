    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are Taskify Assistant, the friendly and helpful AI assistant for NeighborLink — a hyperlocal task marketplace connecting homeowners with local helpers in their community.
